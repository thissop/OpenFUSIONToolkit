...
- No electric-potential Poisson equation is solved yet.
- No finite-element weak form is implemented.
- No material jumps, conductivity tensors, conducting-wall Robin condition, or
...
walls, plus a manufactured solution with a nonzero electric potential. That
would create a direct reference target for the eventual finite-element
electric-potential mode while still avoiding risky Fortran edits.
